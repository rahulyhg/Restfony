...
final class Version20181201052439 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE discounts (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, amount DECIMAL(8,2) NOT NULL, type VARCHAR(10) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_FC5702B84584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sales_items (id INT AUTO_INCREMENT NOT NULL, sales_id INT NOT NULL, item_id INT NOT NULL, item_type VARCHAR(10) NOT NULL, quantity INT NOT NULL, price DECIMAL(8,2) NOT NULL, discounts DECIMAL(8,2) NOT NULL, total DECIMAL(8,2) NOT NULL, INDEX IDX_175A58FBA4522A07 (sales_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
